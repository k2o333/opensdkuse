...
describe("cli.parseArgs", () => {
  ...
  it("throws on empty input", () => {
    ...
    assert.throws(
      () => validateInput(args.userInput, 100000),
      (err: any) => err instanceof AppError && err.code === "INPUT_INVALID",
    );
  });
